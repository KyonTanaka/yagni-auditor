...
[![Estado: Listo para Producción](https://img.shields.io/badge/Estado-Listo%20para%20Producci%C3%B3n-brightgreen)]()
...
**"No lo vas a necesitar" — Auditoría inteligente de dependencias, configuraciones y sistemas de skills.**
...
- ✅ Auditar sistema de skills ya instaladas (detectar sobre-ingeniería)
- ✅ Revisar configuraciones (ej: `CLAUDE.md`) para encontrar ciclos ocultos
- ✅ Optimizar costo de tokens en prompts del sistema
...
### Opción 1: Copiar archivo (Recomendada)
```bash
# Clonar o descargar el repositorio
git clone https://github.com/KyonTanaka/yagni-auditor.git
cd yagni-auditor

# Copiar el skill a tu directorio de skills
cp yagni-audit.md ~/.claude/skills/
```

### Opción 2: Descarga directa
```bash
# Descargar solo el skill
...
1. Descarga `yagni-audit.md` desde [releases](https://github.com/KyonTanaka/yagni-auditor/releases)
2. Copia a `~/.claude/skills/yagni-audit.md`
...
### Fase 4: Ciclos de Activación Ocultos
...
Ver `EXAMPLES_ES.md` (o `EXAMPLES.md` en inglés) para:
...
Cada auditoría genera un reporte con:

```
╔═════════════════════════════════════════════════════════════╗
║           REPORTE DE AUDITORÍA YAGNI — v2.0               ║
╚═════════════════════════════════════════════════════════════╝
...
- 🇪🇸 [Documentación en Español](INSTALLATION_ES.md) — Guía de instalación, ejemplos y más
