...
- ✅ Acceso a `~/.claude/skills/` directory
- ✅ Permisos de lectura/escritura en home directory
...
# Verificar tamaño (debe ser ~7.5 KB)
du -h ~/.claude/skills/yagni-audit.md
```

### **Opción 2: Claude Code**
```
Usuario: "¿Qué skills tengo instalados que empiezan con 'yagni'?"
...
**Síntoma:**
```
cp: permission denied: ~/.claude/skills/yagni-audit.md
```
...
# (No debe encontrar nada — YAGNI es análisis estático puro)
```
...
1. **Lee el README.md** para entender cómo funciona
2. **Mira EXAMPLES.md** para casos de uso reales
...
Si tienes problemas:
- 📖 Lee [EXAMPLES.md](EXAMPLES.md) para casos de uso
- 📋 Revisa [DISCLAIMER.md](DISCLAIMER.md) para limitaciones
- 🔒 Consulta [SECURITY_AUDIT.md](SECURITY_AUDIT.md) para detalles de seguridad
