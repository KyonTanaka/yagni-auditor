...
- ✅ Cero telemetría
- ✅ Cero llamadas a servidores (excepto GitHub API si es crítico)
...
**Nunca applies múltiples recomendaciones YAGNI simultáneamente en producción.**
...
**Escenario:** YAGNI recomienda "elimina librería X (aparentemente redundante)". Lo haces. Resulta que X era crítica para Y que lo llama en 3 lugares ocultos.
...
- No reportes vulnerabilidades públicamente; usa responsable disclosure
